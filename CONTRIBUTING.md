...
* Submit an [issue ticket](https://github.com/managei/MLOps_task-01/issues)
...
This documented is based in the work from [anselmh/CONTRIBUTING.md](https://github.com/anselmh/CONTRIBUTING.md) and  [social-app-flask/CONTRIBUTING.md](https://github.com/python-social-auth/social-app-flask/blob/master/CONTRIBUTING.md),
